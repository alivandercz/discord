...
DEFAULT_MESSAGE = os.getenv("CODES_MESSAGE", "Here's your secret code 1111 - infinity speed")
CODES_CHANNEL_ID = int(os.getenv("CODES_CHANNEL_ID", "1498405553838489763"))
